    ...
    <div style={{ display: "flex", minHeight: "100vh", background: "#0e0e10", color: "white", marginLeft: 250, padding: 20 }}>
      <div style={{ flex: 1, paddingRight: 20 }}>
        ...
        {showInstructions && broadcasterUrl && (
          ...
          >
            <h2 style={{ margin: "0 0 12px 0", fontSize: "20px" }}>🎥 Iniciar transmisión con VDO.Ninja</h2>
            <p style={{ margin: "0 0 16px 0", opacity: 0.95 }}>
              Haz clic en el botón de abajo para abrir VDO.Ninja y comenzar a transmitir.  
              Permite el acceso a tu cámara y micrófono cuando se te solicite.
            </p>
            <button
