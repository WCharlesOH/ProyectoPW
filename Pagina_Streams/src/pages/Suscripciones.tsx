      ...
      >
        <div style={{ flex: 1 }}>
          ...
          <p style={{ margin: 0, opacity: 0.8 }}>
            Consulta tus renovaciones y los beneficios activos.
          </p>
        </div>
        <div
          style={{
        ...
        >
          ...
          <p style={{ margin: "6px 0", fontSize: 32, fontWeight: 700 }}>
            {resumen.activas}
          </p>
      ...
      >
        {cargando ? (
          ...
          >
            ...
            <p style={{ fontSize: 14 }}>
              Busca streamers y suscríbete para apoyarlos
            </p>
          </div>
        ) : (
          suscripciones.map((item, index) => (
            <article
              key={item.ID_Streamer || index}
              style={{ background: "#1f1f23", padding: 14, borderRadius: 10 }}
            >
              <div
                style={{
                  display: "flex",
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  ...
                  >
                    <h3 style={{ margin: 0 }}>
                      {item.streamer?.NombreUsuario || "Usuario"}
                    </h3>
                    <div
                  ...
                  <p
                    style={{ margin: "6px 0 0 0", opacity: 0.8, fontSize: 14 }}
                  >
