  ...
  return (
    ...
    >
      <div style={{ maxWidth: "800px", margin: "0 auto" }}>
        <h2 style={{ color: "#00b7ff", marginBottom: "30px" }}>
          Seleccionar Logros
        </h2>
        ...
        >
          {logros.map((logro) => (
            <div
              ...
              style={{
                flex: "0 1 45%",
                backgroundColor: logrosSeleccionados.includes(logro.ID)
                  ? "#00b7ff"
                  : "#1f1f23",
                color: "white",
                padding: "15px",
                ...
                cursor: "pointer",
                transition: "all 0.3s",
                border: logrosSeleccionados.includes(logro.ID)
                  ? "2px solid #fff"
        ...
        <div style={{ display: "flex", gap: "15px", justifyContent: "center" }}>
          <button
            ...
            style={{
              backgroundColor:
                logrosSeleccionados.length === 0 ? "#555" : "#00ff7f",
              color: "white",
              border: "none",
              borderRadius: "8px",
              padding: "12px 30px",
              fontWeight: "bold",
              cursor:
                logrosSeleccionados.length === 0 ? "not-allowed" : "pointer",
              fontSize: "16px",
            }}
          >
