...
export default function App() {
  ...
  const datos: Usuario | null = JSON.parse(
    ...
    <AuthProvider>
      <div className="app-shell">
        ...
        <div className="app-body">
          {!hideSidebar && <Sidebar onToggle={setSidebarOpen} />}
          ...
          >
            <Routes>
              ...
              <Route
                ...
                element={<CategoriaPagina sidebarAbierto={sidebarOpen} />}
              />
              ...
              <Route
                path="/panel"
                element={
                  <PanelControl monedas={monedas} setMonedas={setMonedas} />
                }
              />
              ...
              <Route
                path="/seleccionar-logros/:username"
                element={<SeleccionarLogros />}
              />
              <Route
                path="/live-start"
                element={
                  <LiveStart monedas={monedas} setMonedas={setMonedas} />
                }
              />
