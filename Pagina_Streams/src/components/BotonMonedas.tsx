...
export default function BotonMonedas({
  monedas = 0,
  setMonedas,
  streamerName,
}: BotonMonedasProps) {
  ...
  const enviarMonedas = async (cantidad: number) => {
    ...
    try {
      console.log(
        `🔄 [BotonMonedas] Enviando ${cantidad} monedas a ${streamerName}...`
      );
      ...
      console.log(
        `✅ [BotonMonedas] Streamer encontrado: ${streamerName} (ID: ${streamerID}, Monedas actuales: ${monedasStreamer})`
      );
      ...
      console.log(
        `✅ [BotonMonedas] Monedas del usuario actualizadas: ${nuevasMonedasUsuario}`
      );
      ...
      console.log(
        `✅ [BotonMonedas] Monedas del streamer actualizadas: ${nuevasMonedasStreamer}`
      );
      ...
      {abierto && coords && (
        ...
        >
          ...
          <div style={{ marginBottom: 12 }}>
            ...
            {streamerName && (
              <p
                style={{ fontSize: "12px", color: "#9147ff", marginBottom: 8 }}
              >
            ...
            <button
              ...
              style={{
                ...
                padding: "10px",
                backgroundColor:
                  cantidadEnviar && parseInt(cantidadEnviar) > 0
                    ? "#00b7ff"
                    : "#555",
                border: "none",
                color:
