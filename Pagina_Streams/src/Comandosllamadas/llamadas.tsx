...
export const API = {
  ...
  SuscripcionesCanal: async (idCanal: number) => {
    try {
      ...
      return {
        success: false,
        error: "Error al obtener suscripciones del canal",
      };
    }
  },
  ...
  EliminarSuscripcion: async (idUsuario: number, idStreamer: number) => {
    try {
      const response = await fetch(
        "http://localhost:5000/Eliminar_Suscripcion",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
  ...
  ObtenerDatosUsuario: async (idUsuario: number) => {
    try {
      const response = await fetch(
        "http://localhost:5000/ObtenerDatosUsuario",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
  ...
  ObtenerDatosUsuarioNombre: async (nombreUsuario: string) => {
    try {
      const response = await fetch(
        "http://localhost:5000/ObtenerDatosUsuarioNombre",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
  ...
  ActualizarNivelviewer: async (
    ...
    try {
      const response = await fetch(
        "http://localhost:5000/Actualizar_NivelViewer",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
      ...
      return {
        success: false,
        error: "Error al actualizar nivel y puntos del viewer",
      };
    }
  },
  ...
  ActualizarNivelStreams: async (idStreamer: number, nivel: number) => {
    try {
      const response = await fetch(
        "http://localhost:5000/Actualizar_NivelStreams",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
      ...
      return {
        success: false,
        error: "Error al actualizar nivel del streamer",
      };
    }
  },
  ...
  ActualizarHorasStreaming: async (idStreamer: number, horas: number) => {
    try {
      const response = await fetch(
        "http://localhost:5000/Actualizar_HorasTransmision",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
      ...
      console.error(
        "Error al actualizar horas de streaming del streamer:",
        error
      );
      return {
        success: false,
        error: "Error al actualizar horas de streaming del streamer",
      };
    }
  },
  ...
  ObtenerRanking: async () => {
    try {
      ...
      return {
        success: false,
        error: "Error al obtener el ranking de streamers",
      };
    }
  },
  ...
  MasVistos: async () => {
    try {
      ...
      return {
        success: false,
        error: "Error al obtener los streamers más vistos",
      };
    }
  },
  ...
  SeguidosEnVIvo: async (idUsuario: number) => {
    try {
      ...
      return {
        success: false,
        error: "Error al obtener los streamers seguidos",
      };
    }
  },
  ...
  ActualizarEnVivo: async (idStreamer: number, EnVIvo: string) => {
    try {
      const response = await fetch(
        "http://localhost:5000/Actualizar_Estado_EnVivo",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
      ...
      return {
        success: false,
        error: "Error al actualizar estado en vivo del streamer",
      };
    }
  },
  ...
  ActualizarMonedas: async (idStreamer: number, nuevasMonedas: number) => {
    try {
      ...
      return {
        success: false,
        error: "Error al actualizar monedas del streamer",
      };
    }
  },
  ...
  VincularJuegoVideo: async (ID_Juego: number, ID_Video: number) => {
    try {
      const response = await fetch(
        "http://localhost:5000/Vincular_Juego_Video",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  EliminarVideo: async (ID_Video: number) => {
    try {
  ...
  EliminarRegalo: async (nombre: string) => {
    try {
      const response = await fetch(
        `http://localhost:5000/regalos/eliminar?nombre=${encodeURIComponent(
          nombre
        )}`
      );
  ...
  BuscarVideos: async (texto: string) => {
    try {
      const response = await fetch(
        `http://localhost:5000/videos/buscar?q=${encodeURIComponent(texto)}`
      );
